Write a status report for your current session to `_ivy/reports/status-{your-agent-name}-{date}.md`.

Include:
- **Agent:** Your name (thorn, bloom, root, or canopy)
...
Keep it concise. This report is read by Thorn for coordination and by Kyle for async review.
